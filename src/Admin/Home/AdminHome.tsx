          ...
          <div className="d-none d-md-flex flex-column mb-auto">
            <ul className="nav ms-4 flex-column">
              <li className="nav-item">
                ...
                <Link to="../../admin"><a className="nav-link" href="!">
                  <svg
                    className="me-2"
                ...
                {/* Second NAV */}
                <Link to="../../admin/activeList"> <a className="nav-link" href="@">
                  <svg
                    className="me-2"
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                ...
                {/* Third NAV */}
                <Link to="../../admin/inActiveList">  <a className="nav-link" href="@">
                  <svg
                    className="me-2"
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                ...
                {/* Forth NAV */}
                <Link to="../../admin/withdrawRequest"> <a className="nav-link" href="@">
                  <svg
                    className="me-2"
                    xmlns="http://www.w3.org/2000/svg"
                    width="18.8"
        ...
        <div id={classes.mainContent} className="col">
          <nav className="navbar no-border flex-md-nowrap container-fluid">
            <div className="col-auto ms-auto me-5">
              <button type="button" className="btn btn-txt">
                Logout
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
